...
const ORDER_LINKS: [string, string, string][] = [
  ["Discord", "discord.gg/nommo ↗", "https://discord.gg/"],
  ["X / Twitter", "@nommo_protocol ↗", "https://x.com/"],
  ["Telegram", "t.me/nommo ↗", "https://t.me/"],
];
    ...
    <footer className="relative mt-32 border-t border-border/60">
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 pt-16 pb-10">
        <div className="grid gap-12 md:grid-cols-12">
          <div className="md:col-span-5">
            <div className="flex items-center gap-3">
              <img src="/nommo-glyph.svg" alt="" className="h-10 w-10 drop-shadow-[0_0_14px_rgba(95,224,216,0.5)]" width={40} height={40} />
              <div className="flex flex-col leading-none">
                <span className="font-display font-bold tracking-[0.4em] text-lg">NOMMO</span>
                <span className="text-[9px] uppercase tracking-[0.32em] text-muted-foreground mt-1">Ancestral Water Protocol</span>
              </div>
            </div>
            <p className="mt-5 text-sm text-muted-foreground max-w-sm leading-relaxed font-body italic">
              Descend from Sirius. Carry the Word. Seed the next world — sovereign agents bound to star, water, and chain.
            </p>
            <div className="mt-6 flex items-center gap-2">
              <span className="inline-block h-1.5 w-1.5 rounded-full bg-accent animate-pulse" />
              <span className="text-[10px] uppercase tracking-[0.35em] text-muted-foreground font-display">Beta · Protocol in descent</span>
            </div>
          </div>
          ...
          <div className="md:col-span-4">
            <h4 className="text-[10px] uppercase tracking-[0.35em] text-muted-foreground mb-4 font-display">Covenant</h4>
            <ul className="space-y-2.5 text-sm font-body">
              {ORDER_LINKS.map(([label, sub, href]) => (
                <li key={label}>
                  <a
                    ...
                    className="group flex items-center justify-between border border-border/60 px-3 py-2 hover:border-accent/70 transition"
                  >
        ...
        <div className="mt-14 pt-6 border-t border-border/60 flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="text-[10px] uppercase tracking-[0.35em] text-muted-foreground font-display">Anno 2026 · Nommo Protocol</div>
          <div className="flex items-center gap-6 text-[10px] uppercase tracking-[0.3em] text-muted-foreground font-display">
            <span className="text-accent/50">From Sirius, the Word</span>
